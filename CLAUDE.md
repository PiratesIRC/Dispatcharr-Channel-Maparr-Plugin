...
- `docs/CHANGELOG.md` — release history and rationale (latest: 2026-06-25 — second matcher-normalization batch from Lineuparr PR #13: non-ASCII preservation, box-bar bouquet-tag strip + delimiters, `calculate_similarity` bug-026 reconciliation, bug-062/bug-066).
