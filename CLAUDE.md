...
- `docs/CHANGELOG.md` — release history and rationale (latest: 2026-06-29 — v1.26.1801833, bug-098 callsign-rescue core hardening re-vendor, behavior-identical; previous 2026-06-28 matcher shared-core migration, `FuzzyMatcher` subclasses the vendored `FuzzyMatcherCore`).
