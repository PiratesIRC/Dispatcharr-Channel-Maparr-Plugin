...
- `docs/CHANGELOG.md` — release history and rationale (latest: 2026-06-28 — matcher shared-core migration, `FuzzyMatcher` subclasses the vendored `FuzzyMatcherCore`; previous 2026-06-25 second matcher-normalization batch from Lineuparr PR #13).
